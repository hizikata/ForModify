...
export class StaffEfficiencyDisplayComponent implements OnInit {
  ...
  public option3: any;
  public option4: any;
  public dataMap: DataMap = new DataMap(null, null, null, null, null, null);
  constructor() {
          ...
          tooltip: {
            ...
            axisPointer: {
              ...
              label: {
                show: true,
                formatter: function (params) {
                  return params.valueobject.replace('\n', '');
                }
              }
            }
          }
...
export class DataMap {
  constructor(
    public dataGDP: object,
    public dataPI: object,
    public dataSI: object,
    public dataTI: object,
    public dataEstate: object,
    public dataFinancial: object,
  ) { }
}
